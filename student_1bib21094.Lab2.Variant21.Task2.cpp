...
double RBPO::Lab2::Variant21::Task2::function1(double x, double y) {
	return (std::sqrt(x) - std::sqrt(y)) / x;
}

double RBPO::Lab2::Variant21::Task2::function2(double x) {
	double result;
...
double RBPO::Lab2::Variant21::Task2::function4(double e) {
	double sum = 0.0;
	double prevSum = 0.0;
	double nextSum = 0.0;
	int k = 0, i = 0;
